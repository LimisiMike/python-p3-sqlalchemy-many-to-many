...
game_user = Table(    #This is an association table for many-to-many rlnshp. Always kept at the top of the other models
    'game_users',
    Base.metadata,
...
class Game(Base):
    ...
    users = relationship('User', secondary=game_user, back_populates='games') #The secondary argument refers to the intermediary table in a many-to-many relationship
